...
puts mean("Rome", data)
puts mean("NY", data)
puts mean("Tokyo", data)
puts mean("F", data)
puts variance("Rome", data1)
puts variance("NY", data1)
puts variance("Tokyo", data1)
puts variance("F", data1)
